...
class View {
    ...
    updateEditor(product) {
        ...
        this.model.value = product.model;
    ...
    buildTable(products) {
        ...
        for (let i=0; i<products.length; i++) {
            html += `
            <tr data-furniture_id="${products[i].furniture_id}" data-num="${products[i].furniture_id}" data-name="${products[i].name}" data-model="${products[i].model}" data-cost="${products[i].cost}"
            data-color="${products[i].color}" data-weight="${products[i].weight}" >
                ...
                <td class="model">${products[i].model}</td>
